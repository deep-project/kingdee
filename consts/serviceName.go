...
const (
	...
	// 未实现
	GetDataCenterList_API  = "Kingdee.BOS.ServiceFacade.ServicesStub.Account.AccountService.GetDataCenterList.common.kdsvc" // 获取数据中心列表
	ExcuteOperation_API    = "Kingdee.BOS.WebApi.ServicesStub.DynamicFormService.ExcuteOperation.common.kdsvc"              // 操作
	...
	QueryBusinessInfo_API  = "Kingdee.BOS.WebApi.ServicesStub.DynamicFormService.QueryBusinessInfo.common.kdsvc"            // 查询单据
	WorkflowAudit_API      = "Kingdee.BOS.WebApi.ServicesStub.DynamicFormService.WorkflowAudit.common.kdsvc"                // 工作流审批
	QueryGroupInfo_API     = "Kingdee.BOS.WebApi.ServicesStub.DynamicFormService.QueryGroupInfo.common.kdsvc"               // 查询分组信息
	...
	ExecuteOperation_API   = "Kingdee.BOS.WebApi.ServicesStub.DynamicFormService.ExecuteOperation.common.kdsvc"             // 禁用
	SwitchOrg_API          = "Kingdee.BOS.WebApi.ServicesStub.DynamicFormService.SwitchOrg.common.kdsvc"                    // 切换组织
	CancelAssign_API       = "Kingdee.BOS.WebApi.ServicesStub.DynamicFormService.CancelAssign.common.kdsvc"                 // 撤销服务
