...
func (c *Client) View(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.View_API, map[string]any{"formId": formid, "data": data})
}

// 保存
func (c *Client) Save(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.Save_API, map[string]any{"formId": formid, "data": data})
}

// 批量保存
func (c *Client) BatchSave(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.BatchSave_API, map[string]any{"formId": formid, "data": data})
}

// 弹性域保存
func (c *Client) FlexSave(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.FlexSave_API, map[string]any{"formId": formid, "data": data})
}

// 暂存
func (c *Client) Draft(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.Draft_API, map[string]any{"formId": formid, "data": data})
}

// 删除
func (c *Client) Delete(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.Delete_API, map[string]any{"formId": formid, "data": data})
}

// 提交
func (c *Client) Submit(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.Submit_API, map[string]any{"formId": formid, "data": data})
}

// 审核
func (c *Client) Audit(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.Audit_API, map[string]any{"formId": formid, "data": data})
}

// 反审核
func (c *Client) UnAudit(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.UnAudit_API, map[string]any{"formId": formid, "data": data})
}

// 下推
func (c *Client) Push(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.Push_API, map[string]any{"formId": formid, "data": data})
}

// 撤销
func (c *Client) CancelAssign(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.CancelAssign_API, map[string]any{"formId": formid, "data": data})
}

// 单据查询
func (c *Client) ExecuteBillQuery(data any) (raw []byte, err error) {
	return c.Core.Call(consts.ExecuteBillQuery_API, map[string]any{"data": data})
}

// 单据查询(json)
func (c *Client) BillQuery(data any) (raw []byte, err error) {
	return c.Core.Call(consts.BillQuery_API, map[string]any{"data": data})
}
...
func (c *Client) ExecuteOperation(formid string, operateNumber string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.ExecuteOperation_API, map[string]any{"formId": formid, "opNumber": operateNumber, "data": data})
}
...
func (c *Client) QueryBusinessInfo(data any) (raw []byte, err error) {
	return c.Core.Call(consts.QueryBusinessInfo_API, map[string]any{"data": data})
}

// 工作流审批
func (c *Client) WorkflowAudit(data any) (raw []byte, err error) {
	return c.Core.Call(consts.WorkflowAudit_API, map[string]any{"data": data})
}

// 切换组织
func (c *Client) SwitchOrg(data any) (raw []byte, err error) {
	return c.Core.Call(consts.SwitchOrg_API, map[string]any{"data": data})
}

// 上传附件
func (c *Client) AttachmentUpLoad(data any) (raw []byte, err error) {
	return c.Core.Call(consts.AttachmentUpLoad_API, map[string]any{"data": data})
}

// 下载附件
func (c *Client) AttachmentDownLoad(data any) (raw []byte, err error) {
	return c.Core.Call(consts.AttachmentDownLoad_API, map[string]any{"data": data})
}

// 分配
func (c *Client) Allocate(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.Allocate_API, map[string]any{"formId": formid, "data": data})
}

// 取消分配
func (c *Client) CancelAllocate(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.CancelAllocate_API, map[string]any{"formId": formid, "data": data})
}

// 拆单
func (c *Client) Disassembly(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.Disassembly_API, map[string]any{"formId": formid, "data": data})
}

// 分组保存
func (c *Client) GroupSave(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.GroupSave_API, map[string]any{"formId": formid, "data": data})
}

// 分组信息查询
func (c *Client) QueryGroupInfo(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.QueryGroupInfo_API, map[string]any{"formId": formid, "data": data})
}

// 分组删除
func (c *Client) GroupDelete(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.GroupDelete_API, map[string]any{"formId": formid, "data": data})
}

// 查询报表数据
func (c *Client) GetSysReportData(formid string, data any) (raw []byte, err error) {
	return c.Core.Call(consts.GetSysReportData_API, map[string]any{"formId": formid, "data": data})
}

// 发送消息
func (c *Client) SendMsg(data any) (raw []byte, err error) {
	return c.Core.Call(consts.SendMsg_API, map[string]any{"data": data})
}
...
func (c *Client) GetInventoryData(data any) (raw []byte, err error) {
	return c.Core.Call(consts.GetInventoryData_API, map[string]any{"data": data})
}
